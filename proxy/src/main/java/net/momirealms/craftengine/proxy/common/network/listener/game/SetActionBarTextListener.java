...
public final class SetActionBarTextListener {
    private SetActionBarTextListener() {}

    public static void register(PacketHandlerRegistry registry, ProxyCraftEngine plugin) {
        PacketRoute route = PacketRoute.typed(ConnectionState.PLAY, PacketType.Play.Server.ACTION_BAR);
