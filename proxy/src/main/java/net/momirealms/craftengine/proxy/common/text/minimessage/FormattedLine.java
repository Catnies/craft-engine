...
public interface FormattedLine {
    ...
    private static TagResolver createDummyResolvers(String tag) {
        return new TagResolver() {
            ...
            @Override
            public @org.jspecify.annotations.Nullable Tag resolve(String name, ArgumentQueue arguments, net.kyori.adventure.text.minimessage.Context ctx) throws ParsingException {
                return null;
            }
        };
    }
    ...
    class PreParsedLine implements FormattedLine {
        ...
        @Override
        public Component parse(Context context) {
            return this.parsed;
        }
    }
